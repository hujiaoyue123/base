...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        /**
         * also used as XML Mapper namespace if a Java requestMapper is generated
         */
...
//        }
        ...
        String namespace = getMyBatis3FallbackSqlMapNamespace();
        if (namespace == null) {
            namespace = getMyBatis3JavaMapperType();
        }
